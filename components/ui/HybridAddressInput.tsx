        ...
        <div className="absolute z-10 w-full mt-2 bg-white/10 backdrop-blur-md border border-white/30 rounded-xl shadow-lg max-h-60 overflow-y-auto">
          {suggestions.map((suggestion, index) => (
            <button
              ...
              className="w-full text-left px-4 py-3 text-white hover:bg-white/20 transition-colors flex items-center space-x-3"
            >
      ...
      <div className="mt-2 p-3 bg-red-500/20 border border-red-500/50 rounded-lg">
        <div className="flex items-start space-x-2">
          ...
          <div className="flex-1">
            <p className="text-red-200 text-sm">Google Maps yüklenemedi. Manuel adres girişi veya listeden seçim yapabilirsiniz.</p>
